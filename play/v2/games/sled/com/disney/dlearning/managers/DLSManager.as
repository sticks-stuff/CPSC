class com.disney.dlearning.managers.DLSManager
{
    ...
    function pushOpcode2Params(opcode, guid, callback, register1, register2)
    {
        ...
        _loc3 = "http://" + com.disney.dlearning.managers.DLSManager.__host + "/v1/opcode/pushOpcode/" + opcode + "/" + com.disney.dlearning.managers.DLSManager.__learnerID + "/" + _loc4 + "/" + guid + "/" + register1 + "/" + register2 + "/";
