class com.clubpenguin.tower.levels.types.Level4 extends com.clubpenguin.tower.levels.types.AbstractLevel
{
    var _view, elements, __currPath, paths, waypoints, dropZones, setDroppableSpots, updateListeners;
    function Level4(scope, levelNum)
    {
        super(scope, new com.clubpenguin.tower.levels.views.Level4View(scope), levelNum);
    ...
    function buildLevelPaths()
    {
        paths = new Array();
        waypoints = new Array();
        waypoints.push(new flash.geom.Point(-1.545000E+001, 3.514500E+002));
        waypoints.push(new flash.geom.Point(1.084500E+002, 3.514500E+002));
        waypoints.push(new flash.geom.Point(1.084500E+002, 1.514500E+002));
        waypoints.push(new flash.geom.Point(2.304500E+002, 1.514500E+002));
        waypoints.push(new flash.geom.Point(2.304500E+002, 3.564500E+002));
        waypoints.push(new flash.geom.Point(3.584500E+002, 3.564500E+002));
        waypoints.push(new flash.geom.Point(3.584500E+002, 1.494500E+002));
        waypoints.push(new flash.geom.Point(4.844500E+002, 1.494500E+002));
        waypoints.push(new flash.geom.Point(4.844500E+002, 3.544500E+002));
        waypoints.push(new flash.geom.Point(6.104500E+002, 3.544500E+002));
        waypoints.push(new flash.geom.Point(6.104500E+002, 2.104500E+002));
    ...
    function setDroppableGrid()
    {
        ...
        dropZones.push(new flash.geom.Point(5.128500E+002, 2.982000E+002));
